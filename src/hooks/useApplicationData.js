...
export default function useApplicationData() {
  ...
  function bookInterview(id, interview) {
    ...
    return axios
      ...
      .put(`http://3.140.217.34:8001/api/appointments/${id}`,
        appointment
      )
      .then(() => {
  ...
  function cancelInterview(id) {
    ...
    return axios
      ...
      .delete(`http://3.140.217.34:8001/api/appointments/${id}`)
      .then(() => {
        setState({
          ...state,
          days,
  ...
  useEffect(() => {
    ...
    axios.get("http://3.140.217.34:8001/api/debug/reset")
         ...
         .then(() =>{
          ...
          Promise.all([
            ...
            axios.get("http://3.140.217.34:8001/api/days"),
            // axios.get("http://localhost:8001/api/appointments"),
            axios.get("http://3.140.217.34:8001/api/appointments"),
            // axios.get("http://localhost:8001/api/interviewers")
            axios.get("http://3.140.217.34:8001/api/interviewers")
          ])
            .then((all) => {
              setState((prev) => {
                if (all[0].data) {
